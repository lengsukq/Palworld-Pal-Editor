...
export default {
    ...
    BatchApply_Passive_Button: "批量应用",
    BatchApply_Passive_Button_SameSpecies: "同类批量应用",
    BatchApply_Passive_QuickHint: "将被动技能批量应用到多个帕鲁",
    BatchApply_Passive_Title: "批量应用被动技能",
    BatchApply_Passive_Subtitle: "选择目标范围与应用方式，然后选择要应用的被动技能。",
    BatchApply_Passive_Scope: "目标范围",
    BatchApply_Passive_Scope_Filtered: "当前筛选列表",
    BatchApply_Passive_Scope_All: "当前玩家全部帕鲁",
    BatchApply_Passive_Mode: "应用方式",
    BatchApply_Passive_Mode_Replace: "覆盖（先清空再设置）",
    BatchApply_Passive_Mode_Add: "追加（已有的不变，尽量补满）",
    BatchApply_Passive_Skills: "要应用的被动技能（最多 4 个）",
    BatchApply_Passive_Hint: "提示：重复选择会自动去重；开启“隐藏作弊选项”时，每只帕鲁最多 4 个被动技能。",
    BatchApply_Clear: "清空",
    BatchApply_Confirm: "应用",
    Cancel: "取消",
    BatchApply_TargetPals: "目标帕鲁",
    BatchApply_SelectSameSpecies: "选择同类帕鲁",
    BatchApply_ClearSelection: "清空选择",
    BatchApply_TargetPals_Hint:
        "如果不勾选具体帕鲁，将应用到上方范围内的所有帕鲁；勾选后仅对勾选的帕鲁生效。",
    BatchApply_TargetPals_Search: "按名称搜索帕鲁",

    BatchTemplate_Title: "同类帕鲁模板批量应用",
    BatchTemplate_Subtitle: "将当前选中帕鲁的配置应用到同种的其他帕鲁上。",
    BatchTemplate_Target: "目标帕鲁",
    BatchTemplate_Target_CountUnit: "只",
    BatchTemplate_Target_Hint: "仅会影响与当前帕鲁为同一物种、且符合当前筛选条件的帕鲁（不包括当前这只）。",
    BatchTemplate_Sections: "需要同步的内容",
    BatchTemplate_Section_Passive: "被动技能",
    BatchTemplate_Section_Suitability: "工作适应性",
    BatchTemplate_Section_Talent: "个体值",
    BatchTemplate_Section_Souls: "帕鲁强化（力量雕像）",
